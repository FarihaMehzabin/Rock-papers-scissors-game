...
function getPlayerCode(target) {
  if (target === "rock" || target === "rock-svg") {
    player = "rock";
    return `<div class="I-picked">
    <div class="rock position">
  ...
  } else if (target === "paper" || target === "paper-svg") {
    player = "paper";
    return `<div class="I-picked">
  ...
  } else if (target === "scissors" || target === "scissors-svg") {
    player = "scissors";
    return `<div class="I-picked">
    <div class="scissors position">
...
function getVerdict() {
  // Draw conditions
  if (house === "scissors" && player === "scissors") {
    return "It's a draw";
  } else if (house === "paper" && player === "paper") {
    return "It's a draw";
  } else if (house === "rock" && player === "rock") {
    return "It's a draw";
  }
